    ...
    <div class="row justify-content-center">
        <div class="col-lg-7">
            ...
            <div class="mb-4 d-flex justify-content-between align-items-center">
                <h2 class="mb-0"><i class="fas fa-trophy me-2 text-warning"></i>Aggiungi Riconoscimento</h2>
            ...
            <form action="{{ route('riconoscimenti.store') }}" method="POST" class="card shadow-sm">
                @csrf
                ...
                <div class="card-body p-4">
                    <div class="mb-3">
                        ...
                        <input type="text" name="titolo" id="titolo" class="form-control @error('titolo') is-invalid @enderror"
                               value="{{ old('titolo') }}" required maxlength="255">
                        @error('titolo')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="url" name="url" id="url" class="form-control @error('url') is-invalid @enderror"
                               value="{{ old('url') }}" required maxlength="512" placeholder="https://...">
                        @error('url')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="estratto" id="estratto" class="form-control @error('estratto') is-invalid @enderror" rows="3" maxlength="1000">{{ old('estratto') }}</textarea>
                        @error('estratto')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
