...
<div class="container mt-4">
    ...
    <h2 class="mb-4"><i class="fas fa-film me-2 text-primary"></i>Aggiungi un Nuovo Video</h2>
        ...
        <div class="card-body">
            <form action="{{ route('videos.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="titolo" class="form-control @error('titolo') is-invalid @enderror" value="{{ old('titolo') }}" required maxlength="255" title="Campo obbligatorio">
                    @error('titolo')
                ...
                <div class="mb-3">
                    ...
                    <textarea name="descrizione" id="descrizione" class="form-control @error('descrizione') is-invalid @enderror" rows="4" maxlength="1000" title="Inserisci una descrizione (max 1000 caratteri)">{{ old('descrizione') }}</textarea>
                    @error('descrizione')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="anno" class="form-control @error('anno') is-invalid @enderror" value="{{ old('anno') }}" title="Anno del video">
                        @error('anno')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" name="durata_secondi" id="durata_secondi" class="form-control @error('durata_secondi') is-invalid @enderror" value="{{ old('durata_secondi') }}" required min="1" title="Campo obbligatorio">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="text" name="formato" class="form-control @error('formato') is-invalid @enderror" placeholder="es. MP4, MOV, AVI" value="{{ old('formato') }}">
                        @error('formato')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="location" id="location-input" class="form-control @error('location') is-invalid @enderror"
                        placeholder="Digita una città o località (es: Roma)" value="{{ old('location') }}" autocomplete="off" required title="Campo obbligatorio">
                    <input type="hidden" name="location_lat" id="location-lat" value="{{ old('location_lat') }}">
                    <input type="hidden" name="location_lon" id="location-lon" value="{{ old('location_lon') }}">
                    @error('location')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="youtube_id" name="youtube_id" class="form-control @error('youtube_id') is-invalid @enderror" value="{{ old('youtube_id') }}">
                    @error('youtube_id')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="autore" class="form-control @error('autore') is-invalid @enderror" placeholder="Nome autore" value="{{ old('autore') }}" maxlength="100">
                    @error('autore')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="famiglie" id="famiglie" class="form-control @error('famiglie') is-invalid @enderror" placeholder="Nomi famiglie separati da virgola"
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="tags" id="tags" class="form-control @error('tags') is-invalid @enderror" placeholder="Nomi tag separati da virgola"
                ...
                <div class="d-flex justify-content-end gap-3 mt-4">
                    <button type="submit" class="btn btn-success"><i class="fas fa-save me-1"></i>Salva Video</button>
                    <a href="{{ route('videos.index') }}" class="btn btn-secondary"><i class="fas fa-times me-1"></i>Annulla</a>
                </div>
            </form>
        </div>
    </div>
...
{{-- Leaflet CSS/JS + Autocomplete + Anteprima YouTube --}}
    ...
    function showLocationList(results) {
        ...
        results.forEach((loc, idx) => {
            ...
            li.innerHTML = `
                ...
                <div style="font-size: 0.95em; color:#666;">${loc.display_name}</div>
                <small class="text-muted"><i class="fas fa-map-pin me-1"></i>${translateType(loc.type)} &middot; ${loc.country}</small>
            `;
